...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2022 at 03:05 PM
...
--
ALTER TABLE `borrow`
  ADD CONSTRAINT `borrow_ibfk_1` FOREIGN KEY (`Member_ID`) REFERENCES `member` (`Member_ID`) ON DELETE SET NULL;

--
-- Constraints for table `borrowdetails`
--
ALTER TABLE `borrowdetails`
  ADD CONSTRAINT `borrowdetails_ibfk_1` FOREIGN KEY (`Book_ID`) REFERENCES `book` (`Book_ID`) ON DELETE SET NULL,
  ADD CONSTRAINT `borrowdetails_ibfk_2` FOREIGN KEY (`Borrow_ID`) REFERENCES `borrow` (`Borrow_ID`) ON DELETE SET NULL;
